          ...
          <div aria-hidden='true' className={`mb-4 ml-3 d-md-flex flex-row justify-content-start${mapClass}`}>
            <div className='d-flex flex-column'>
              ...
              <div className={styles['map-key-container']}>
                <span className={styles['map-key-item']} style={{ backgroundColor: '#FFB400' }}>
                  Model State
                </span>
                <span className={styles['map-key-item']} style={{ backgroundColor: '#00CFCE' }}>
                  Financial Security Friendly
                </span>
                <span className={styles['map-key-item']} style={{ backgroundColor: '#AAE5E1' }}>
                  Taking Steps
                </span>
                <span className={styles['map-key-item']} style={{ backgroundColor: '#FF9194' }}>
                  Some Accountability
                </span>
                <span className={styles['map-key-item']} style={{ backgroundColor: '#FF583D' }}>
...
export async function getStaticProps() {
  ...
  let watchlistStates = allStates
    ...
    .sort((stateA, stateB) => stateA.watchlistPosition - stateB.watchlistPosition)
