...
const StateUpdates = () => {
  ...
  return (
    ...
    >
      {submitted && (
        <div className="alert alert-success" role="alert">
          <h4 className="alert-heading">
            Thanks for signing up for state updates!
          </h4>
          <p>
            Be sure to finish the subscription process on the Mailchimp page.
          </p>
          <hr />
          <button
      ...
      >
        <p className="small">
          We&apos;ll be updating our mapping tool as states pass new policies.
          Sign up below and we&apos;ll send you an email when the state(s) you
          select passes a policy that impacts survivors&apos; financial
          security.
        </p>
        <form
          // eslint-disable-next-line max-len
          ...
          <div id="mc_embed_signup_scroll">
            ...
            <div className="mc-field-group mb-4">
              ...
              <input
                type="email"
                name="EMAIL"
                className="required email small"
                id="mce-EMAIL"
              />
            </div>
              ...
              <ul className="no-indents no-bullets mb-0">
                <li>
                  ...
                  <label
                    ...
                    htmlFor="mce-group[30989]-30989-0"
                  >
                    Alabama
                  </label>
                </li>
                <li>
                  ...
                  <label
                    className="checkbox small"
                    htmlFor="mce-group[30989]-30989-1"
                  >
                    Alaska
                  </label>
                </li>
                <li>
                  ...
                  <label
                    className="checkbox small"
                    htmlFor="mce-group[30989]-30989-2"
                  >
                    Arizona
                  </label>
                </li>
                <li>
                  ...
                  <label
                    className="checkbox small"
                    htmlFor="mce-group[30989]-30989-3"
                  >
                    Arkansas
                  </label>
                </li>
                <li>
                  ...
                  <label
                    className="checkbox small"
                    htmlFor="mce-group[30989]-30989-4"
                  >
                    California
                  </label>
                </li>
                <li>
                  ...
                  <label
                    className="checkbox small"
                    htmlFor="mce-group[30989]-30989-5"
                  >
                    Colorado
                  </label>
                </li>
                <li>
                  ...
                  <label
                    className="checkbox small"
                    htmlFor="mce-group[30989]-30989-6"
                  >
                    Connecticut
                  </label>
                </li>
                <li>
                  ...
                  <label
                    className="checkbox small"
                    htmlFor="mce-group[30989]-30989-7"
                  >
                    Delaware
                  </label>
                </li>
                <li>
                  ...
                  <label
                    className="checkbox small"
                    htmlFor="mce-group[30989]-30989-8"
                  >
                    District of Columbia
                  </label>
                </li>
                <li>
                  ...
                  <label
                    className="checkbox small"
                    htmlFor="mce-group[30989]-30989-9"
                  >
                    Florida
                  </label>
                </li>
                <li>
                  ...
                  <label
                    className="checkbox small"
                    htmlFor="mce-group[30989]-30989-10"
                  >
                    Georgia
                  </label>
                </li>
                <li>
                  ...
                  <label
                    className="checkbox small"
                    htmlFor="mce-group[30989]-30989-11"
                  >
                    Hawaii
                  </label>
                </li>
                <li>
                  ...
                  <label
                    className="checkbox small"
                    htmlFor="mce-group[30989]-30989-12"
                  >
                    Idaho
                  </label>
                </li>
                <li>
                  ...
                  <label
                    className="checkbox small"
                    htmlFor="mce-group[30989]-30989-13"
                  >
                    Illinois
                  </label>
                </li>
                <li>
                  ...
                  <label
                    className="checkbox small"
                    htmlFor="mce-group[30989]-30989-14"
                  >
                    Indiana
                  </label>
                </li>
                <li>
                  ...
                  <label
                    className="checkbox small"
                    htmlFor="mce-group[30989]-30989-15"
                  >
                    Iowa
                  </label>
                </li>
                <li>
                  ...
                  <label
                    className="checkbox small"
                    htmlFor="mce-group[30989]-30989-16"
                  >
                    Kansas
                  </label>
                </li>
                <li>
                  ...
                  <label
                    className="checkbox small"
                    htmlFor="mce-group[30989]-30989-17"
                  >
                    Kentucky
                  </label>
                </li>
                <li>
                  ...
                  <label
                    className="checkbox small"
                    htmlFor="mce-group[30989]-30989-18"
                  >
                    Louisiana
                  </label>
                </li>
                <li>
                  ...
                  <label
                    className="checkbox small"
                    htmlFor="mce-group[30989]-30989-19"
                  >
                    Maine
                  </label>
                </li>
                <li>
                  ...
                  <label
                    className="checkbox small"
                    htmlFor="mce-group[30989]-30989-20"
                  >
                    Maryland
                  </label>
                </li>
                <li>
                  ...
                  <label
                    className="checkbox small"
                    htmlFor="mce-group[30989]-30989-21"
                  >
                    Massachusetts
                  </label>
                </li>
                <li>
                  ...
                  <label
                    className="checkbox small"
                    htmlFor="mce-group[30989]-30989-22"
                  >
                    Michigan
                  </label>
                </li>
                <li>
                  ...
                  <label
                    className="checkbox small"
                    htmlFor="mce-group[30989]-30989-23"
                  >
                    Minnesota
                  </label>
                </li>
                <li>
                  ...
                  <label
                    className="checkbox small"
                    htmlFor="mce-group[30989]-30989-24"
                  >
                    Mississippi
                  </label>
                </li>
                <li>
                  ...
                  <label
                    className="checkbox small"
                    htmlFor="mce-group[30989]-30989-25"
                  >
                    Missouri
                  </label>
                </li>
                <li>
                  ...
                  <label
                    className="checkbox small"
                    htmlFor="mce-group[30989]-30989-26"
                  >
                    Montana
                  </label>
                </li>
                <li>
                  ...
                  <label
                    className="checkbox small"
                    htmlFor="mce-group[30989]-30989-27"
                  >
                    Nebraska
                  </label>
                </li>
                <li>
                  ...
                  <label
                    className="checkbox small"
                    htmlFor="mce-group[30989]-30989-28"
                  >
                    Nevada
                  </label>
                </li>
                <li>
                  ...
                  <label
                    className="checkbox small"
                    htmlFor="mce-group[30989]-30989-29"
                  >
                    New Hampshire
                  </label>
                </li>
                <li>
                  ...
                  <label
                    className="checkbox small"
                    htmlFor="mce-group[30989]-30989-30"
                  >
                    New Jersey
                  </label>
                </li>
                <li>
                  ...
                  <label
                    className="checkbox small"
                    htmlFor="mce-group[30989]-30989-31"
                  >
                    New Mexico
                  </label>
                </li>
                <li>
                  ...
                  <label
                    className="checkbox small"
                    htmlFor="mce-group[30989]-30989-32"
                  >
                    New York
                  </label>
                </li>
                <li>
                  ...
                  <label
                    className="checkbox small"
                    htmlFor="mce-group[30989]-30989-33"
                  >
                    North Carolina
                  </label>
                </li>
                <li>
                  ...
                  <label
                    className="checkbox small"
                    htmlFor="mce-group[30989]-30989-34"
                  >
                    North Dakota
                  </label>
                </li>
                <li>
                  ...
                  <label
                    className="checkbox small"
                    htmlFor="mce-group[30989]-30989-35"
                  >
                    Ohio
                  </label>
                </li>
                <li>
                  ...
                  <label
                    className="checkbox small"
                    htmlFor="mce-group[30989]-30989-36"
                  >
                    Oklahoma
                  </label>
                </li>
                <li>
                  ...
                  <label
                    className="checkbox small"
                    htmlFor="mce-group[30989]-30989-37"
                  >
                    Oregon
                  </label>
                </li>
                <li>
                  ...
                  <label
                    className="checkbox small"
                    htmlFor="mce-group[30989]-30989-38"
                  >
                    Pennsylvania
                  </label>
                </li>
                <li>
                  ...
                  <label
                    className="checkbox small"
                    htmlFor="mce-group[30989]-30989-39"
                  >
                    Rhode Island
                  </label>
                </li>
                <li>
                  ...
                  <label
                    className="checkbox small"
                    htmlFor="mce-group[30989]-30989-40"
                  >
                    South Carolina
                  </label>
                </li>
                <li>
                  ...
                  <label
                    className="checkbox small"
                    htmlFor="mce-group[30989]-30989-41"
                  >
                    South Dakota
                  </label>
                </li>
                <li>
                  ...
                  <label
                    className="checkbox small"
                    htmlFor="mce-group[30989]-30989-42"
                  >
                    Tennessee
                  </label>
                </li>
                <li>
                  ...
                  <label
                    className="checkbox small"
                    htmlFor="mce-group[30989]-30989-43"
                  >
                    Texas
                  </label>
                </li>
                <li>
                  ...
                  <label
                    className="checkbox small"
                    htmlFor="mce-group[30989]-30989-44"
                  >
                    Utah
                  </label>
                </li>
                <li>
                  ...
                  <label
                    className="checkbox small"
                    htmlFor="mce-group[30989]-30989-45"
                  >
                    Vermont
                  </label>
                </li>
                <li>
                  ...
                  <label
                    className="checkbox small"
                    htmlFor="mce-group[30989]-30989-46"
                  >
                    Virginia
                  </label>
                </li>
                <li>
                  ...
                  <label
                    className="checkbox small"
                    htmlFor="mce-group[30989]-30989-47"
                  >
                    Washington
                  </label>
                </li>
                <li>
                  ...
                  <label
                    className="checkbox small"
                    htmlFor="mce-group[30989]-30989-48"
                  >
                    West Virginia
                  </label>
                </li>
                <li>
                  ...
                  <label
                    className="checkbox small"
                    htmlFor="mce-group[30989]-30989-49"
                  >
                    Wisconsin
                  </label>
                </li>
                <li>
                  ...
                  <label
                    className="checkbox small"
                    htmlFor="mce-group[30989]-30989-50"
                  >
                    Wyoming
                  </label>
                </li>
            ...
            <div className="mc-field-group input-group mb-4">
              ...
              <ul className="no-indents no-bullets mb-0">
                <li>
                  ...
                  <label
                    className="checkbox small"
                    htmlFor="mce-group[30977]-30977-0"
                  >
                ...
                <li>
                  ...
                  <label
                    className="checkbox small"
                    htmlFor="mce-group[30977]-30977-1"
                  >
                    Policy changes might help me better support survivors as a
                    service provider
                  </label>
                </li>
                <li>
                  ...
                  <label
                    className="checkbox small"
                    htmlFor="mce-group[30977]-30977-2"
                  >
                ...
                <li>
                  ...
                  <label
                    className="checkbox small"
                    htmlFor="mce-group[30977]-30977-3"
                  >
                    Other
                  </label>
                </li>
            ...
            >
              <input
                type="text"
                name="b_709a0a051cd8a5f3df002da88_54b262f0fa"
                tabIndex="-1"
                defaultValue=""
              />
            </div>
