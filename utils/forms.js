...
export const checkFormStatus = (props) => {
  ...
  if (props.status.success) {
    return (
      <div
        className="mb-5 mb-5 mt-5 alert alert-success d-flex flex-row align-items-center"
        role="alert"
      >
        <span>
          <strong>Thanks for your response!</strong> Someone will be in touch
          with you soon.
        </span>
    ...
    return (
      <div
        className="mb-5 mb-5 mt-5 alert alert-danger d-flex flex-row align-items-center"
        role="alert"
      >
        <span>
